...
//            Route::get('voided/ticket/{voided_id}/{group_id}', 'Tenant\VoidedController@ticket');
            ...
            Route::post('purchases/parse-pdf', 'Tenant\PurchaseController@parsePdf');
            ...
            Route::prefix('restaurant')->group(function() {
                ...
                Route::post('configuration/create-envs', 'Tenant\RestaurantConfigurationController@createTableEnv')->name('tenant.restaurant.configuration.createEnv');
                ...
                Route::prefix('supplies')->group(function () {
                    Route::get('', 'Tenant\SupplyController@index')->name('tenant.restaurant.supplies.index')->middleware('redirect.module');
                    Route::get('records', 'Tenant\SupplyController@records');
                    Route::get('unit-types', 'Tenant\SupplyController@getUnitTypes');
                    Route::post('/', 'Tenant\SupplyController@store');
                    Route::put('{id}/stock', 'Tenant\SupplyController@updateStock');
                    Route::delete('{id}', 'Tenant\SupplyController@destroy');
                });

                // Item Supplies (Insumos por Item)
                Route::prefix('item-supplies')->group(function () {
                    Route::get('{itemId}', 'Tenant\RestaurantItemSupplyController@getItemSupplies');
                    Route::post('', 'Tenant\RestaurantItemSupplyController@storeItemSupplies');
                    Route::post('discount-stock', 'Tenant\RestaurantItemSupplyController@discountSuppliesStock');
                    Route::get('available/list', 'Tenant\RestaurantItemSupplyController@getAvailableSupplies');
                });

                // Modifier groups
                Route::get('/modifier-groups', 'Tenant\ModifierGroupController@indexPage')->name('tenant.restaurant.modifiers-groups.index')->middleware('redirect.module');
                Route::get('/modifier-groups/records', 'Tenant\ModifierGroupController@records');
                Route::post('/modifier-groups', 'Tenant\ModifierGroupController@store');
                Route::get('/modifier-groups/{id}', 'Tenant\ModifierGroupController@show');
                Route::put('/modifier-groups/{id}', 'Tenant\ModifierGroupController@update');
                Route::delete('/modifier-groups/{id}', 'Tenant\ModifierGroupController@destroy');

                // Assign groups to item
                Route::post('/items/{itemId}/modifier-groups', 'Tenant\ModifierGroupController@assignToItem');
                Route::get('/items/{itemId}/modifier-groups', 'Tenant\ModifierGroupController@groupsForItem');
                
                // Preparation Areas (Áreas de preparación)
                Route::prefix('preparation-areas')->group(function () {
                    Route::get('', 'Tenant\PreparationAreaController@index');
                    Route::post('', 'Tenant\PreparationAreaController@store');
                    Route::put('{id}', 'Tenant\PreparationAreaController@update');
                    Route::delete('{id}', 'Tenant\PreparationAreaController@destroy');
                });
            });
            ...
            Route::get('quotations/download/{external_id}/{format?}/{lang?}', 'Tenant\QuotationController@download');
            Route::get('quotations/print/{external_id}/{format?}/{lang?}', 'Tenant\QuotationController@toPrint');
           ...
           Route::get('document_pos_payments/records/{document_pos}', 'Tenant\DocumentPosPaymentController@records');
           Route::get('document_pos_payments/document/{document_pos}', 'Tenant\DocumentPosPaymentController@document');
           Route::get('document_pos_payments/tables', 'Tenant\DocumentPosPaymentController@tables');
           Route::post('document_pos_payments', 'Tenant\DocumentPosPaymentController@store');
           Route::delete('document_pos_payments/{id}', 'Tenant\DocumentPosPaymentController@destroy');
